...
public class Settings {
    ...
    public static double SCENE_WIDTH = 1750;
    public static double SCENE_HEIGHT = 950;

    public static double PLAYER_SHIP_SPEED = 5.0;
    ...
    public static int STAR_SPAWN_RANDOMNESS = 10;
